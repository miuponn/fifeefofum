...
const NavLinks = () => {
    ...
    return (
        <div className="flex items-center space-x-8 text-dark_pink_secondary font-normal font-poppins">
        ...
        <div className="relative" ref={dropdownRef}>
            ...
            className="flex items-center gap-1 relative transition duration-300 ease-in-out group"
            aria-haspopup="true"
            ...
            <div className="absolute left-0 mt-2 w-48 bg-white border border-pink rounded-md shadow-md" role="menu">
                ...
                <Link key={item} to="#" className="block px-4 py-2 text-dark_pink_secondary hover:text-peach transition duration-300" role="menuitem">
                    {item}
                </Link>
                ))}
            </div>
        ...
        <Link to="/faqs" className="hover:text-peach transition duration-300">
            FAQs
        </Link>
        <Link to="/about" className="hover:text-peach transition duration-300">
            About
        </Link>
