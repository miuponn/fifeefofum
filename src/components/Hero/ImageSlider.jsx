    ...
    >
      ...
      {images.length > 1 && isLoaded && (
        <>
          <button
            onClick={prevSlide}
            className={`absolute left-4 top-1/2 transform -translate-y-1/2 z-30 transition-transform duration-300 hover:scale-125 ${
          ...
          <button
            onClick={nextSlide}
            className={`absolute right-4 top-1/2 transform -translate-y-1/2 z-30 transition-transform duration-300 hover:scale-125 ${
              isHovered ? "opacity-100" : "opacity-0"
            }`}
          >
